...
两天生病了，打fxmod，看皮克斯  
12.16:  
回家了，车票64.5;火车上体验太阳帝国的原罪，不好玩退款了。买了给万宇承的礼物，我很喜欢的一本小王子立体插画（100）    
12.17:  
...
12.24:  
先用scrollBox写了一个超酷的选专辑UI。买了个鼓模型，明天渲染。  
12.25:  
这一块钱的UE鼓模型居然是模块化的，帮大忙了。我可以自定义一些鼓面，迅速复刻2005和2020两场经典show的皮肤，重新排布场景里定制了四套鼓，控制灯光和cameraPawn实现根据专辑选择鼓组。整体工程是要规范的，通过controller集中控制所有包括UI。cameraPawn和mediaPlayer。mainUI将划分为五个模块。跟着印度的原神角色UI界面制作教程学点东西，但讲得实在太烂，不过学了一下PS与UE结合工作流和通过time改变UVs制作动态图标。晚上找了好久问题（click模拟touch）才实现了点击鼓组播放动画，但是暂时没有音频。就先做了一个超酷的摄像机运镜切换菜单背景（SpringArm理解）。  
12.26:  
...
12.29:  
把答辩JoJoMayer风格架子鼓视频录制下来发到了b站;两美元买了两款steam小游戏:买了卷发棒(103)，TP-Link路由器（116）   
12.31:  
买辅酶q10(96);stackLand超好玩，一直想要一款好玩有趣而且画面完整度高的文明养成类游戏，这款可以说超过文明6了  
